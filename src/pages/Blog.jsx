const Blog = () => (
  <div className="min-h-screen px-4 sm:px-8 lg:px-12 pb-10">
    <h1 className="text-3xl font-bold mb-6 text-fuchsia-400 border-b border-zinc-700 pb-2 text-left">
      /blog
    </h1>

    <div className="bg-zinc-900/40 backdrop-blur-md border border-zinc-700 rounded-lg p-6 transition duration-300 hover:border-fuchsia-500 hover:shadow-[0_0_12px_#D946EF] max-w-xl w-full text-left">
      <h2 className="text-xl font-semibold text-white mb-2">
        Mastering Workflow Automation with Temporal and Spring Boot
      </h2>
      <p className="text-zinc-300 text-sm mb-4">
        A hands-on walkthrough for backend engineers looking to simplify complex asynchronous flows using Temporal and Spring Boot.
        From design to deployment — this article covers how to think in workflows, not just services.
      </p>
      <a
